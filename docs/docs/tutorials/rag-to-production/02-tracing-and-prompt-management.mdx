...
{/\*
VIDEO SCRIPT BEATS (5-7 min):

- [0:00] "You have a RAG app. It works. But how do you know it works well?"
- [0:30] Show the RAG app running, make a query
- [1:00] Add tracing (show the decorator lines). Run again. Show the trace in Agenta.
- [2:30] Add prompt management. Create prompt in UI. Fetch in code. Change prompt, show different output.
- [4:30] Link traces to prompt versions. Show trace with prompt ref.
- [5:30] Recap and teaser for Part 2.
  \*/}
